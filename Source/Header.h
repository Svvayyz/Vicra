...
#define PAGE_EXECUTABLE_AND_READABLE ((PAGE_EXECUTE_READ | PAGE_EXECUTE_READWRITE) & (~PAGE_GUARD | ~PAGE_NOACCESS))
#define PAGE_EXECUTABLE (PAGE_EXECUTABLE_AND_READABLE | PAGE_EXECUTE | PAGE_EXECUTE_WRITECOPY)
